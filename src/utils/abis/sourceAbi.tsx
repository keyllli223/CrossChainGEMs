export const SOURCE_NFT_SUBSCRIPTION_ABI = [{
    "inputs": [{
        "internalType": "string",
        "name": "collectionURI_",
        "type": "string"
    }, {"internalType": "string", "name": "sourceChain_", "type": "string"}, {
        "internalType": "string",
        "name": "destinationChain_",
        "type": "string"
    }, {"internalType": "string", "name": "destinationAddress_", "type": "string"}, {
    ...
    "inputs": [{"internalType": "bytes32", "name": "commandId", "type": "bytes32"}, {
        ...
        "name": "amount",
        "type": "uint256"
    }], "name": "executeWithToken", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [],
    "name": "gasService",
    "outputs": [{"internalType": "contract IAxelarGasService", "name": "", "type": "address"}],
    "stateMutability": "view",
    "type": "function"
}, {
    "inputs": [],
